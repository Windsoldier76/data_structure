...
eeseosdriemopnadtr
the first order traverse is:
moeeesrdseidapontr
the end order traverse is:
eseesdieroonpartdm
the in order traverse with stack is:
eeseosdriemopnadtr
the level order traverse is:
moderatedepression
--------------------------------------------------
PART 2:
the amount of the binary tree's nodes is 18
the amount of the binary tree's leaves's nodes is 7
the depth of the binary tree is 5
--------------------------------------------------
PART 3:
the in order traverse after the switch is:
rtdanpomeirdsoesee
```
